...
public class LoginBlazeSD {
    ...
    public void ingresaUnNombreDeUsuarioYContraseña(String username, String password) {
        usuario.attemptsTo(Enter.theValue(username).into(LoginPageBlaze.INP_USERNAMEL));
        usuario.attemptsTo(Enter.theValue(password).into(LoginPageBlaze.INP_PASSWORDL));
    }
    ...
    public void elUsuarioProcedeADarLogout() {
